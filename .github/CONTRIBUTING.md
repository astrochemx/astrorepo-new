...
> After this page, see our [Development Guidelines](./DEVELOPMENT.md) for local development instructions.

## Code of Conduct

This project contains a [_Contributor Covenant Code of Conduct_](./CODE_OF_CONDUCT.md) all contributors are expected to follow.

## Reporting Issues

Please do [**report an issue** on the issue tracker](https://github.com/astrochemx/astrorepo/issues/new/choose) if there's any bugfix, documentation improvement, or general enhancement you'd like to see in the repository!
...
With the exception of very small typos, all changes to this repository generally need to correspond to an [unassigned open issue marked as `accepting PRs` on the issue tracker](https://github.com/astrochemx/astrorepo/issues?q=is%3Aissue+is%3Aopen+label%3A%22accepting+prs%22+no%3Aassignee+).
If this is your first time contributing, consider searching for [unassigned issues that also have the `good first issue` label](https://github.com/astrochemx/astrorepo/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22+label%3A%22accepting+prs%22+no%3Aassignee+).
...
If an unassigned issue has been marked as `accepting PRs` and an open PR does not exist, feel free to send a PR.
...
Check [previously merged PRs](https://github.com/astrochemx/astrorepo/pulls?q=is%3Apr+is%3Amerged+-label%3Adependencies+) for reference.
...
Once your PR is merged, if you haven't yet been added to the [_Contributors_](../README.md#contributors) table in the README.md for its [type of contribution](https://allcontributors.org/docs/en/emoji-key 'AllContributors Emoji Key'), you should be soon.
